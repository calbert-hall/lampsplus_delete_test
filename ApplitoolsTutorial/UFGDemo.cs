...
namespace ApplitoolsTutorial
{
    ...
    public class UFGDemo
    {
		...
		public void BeforeEach() {
            ...
            config.SetBatch(new BatchInfo("Ultrafast Batch - Selenium C#"));
		...
		public void UFGTest(){
            ...
            eyes.Open(driver, "Demo App - csharp ufg", "Smoke Test - Should be deleted", new Size(800, 600));
        ...
        {
            // Start the test by setting AUT's name, window or the page name that's being tested, viewport width and height
            eyes.Open(driver, "Demo App - csharp ufg", "Smoke Test - Should show on dashboard", new Size(800, 600));
        ...
        [Test]
        public void UFGTest3()
        {
            // Start the test by setting AUT's name, window or the page name that's being tested, viewport width and height
            eyes.Open(driver, "Demo App - csharp ufg", "Smoke Test GetAllTestResults - Should be deleted", new Size(800, 600));
            ...
            foreach (TestResultContainer result in results)
            {
